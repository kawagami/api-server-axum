...
export const HOME_FEATURES: readonly HomeFeature[] = [
    { key: "blog", href: "/blogs", icon: FileText, label: "文章" },
    { key: "vocab", href: "/vocab", icon: GraduationCap, label: "單字闖關" },
    { key: "games", href: "/games", icon: Gamepad2, label: "對戰遊戲" },
    { key: "ledger", href: "/ledger", icon: Wallet, label: "記帳本" },
    { key: "portfolio", href: "/portfolio", icon: TrendingUp, label: "投資組合" },
    { key: "invoices", href: "/invoices", icon: ReceiptText, label: "發票對獎" },
    { key: "lotto", href: "/lotto", icon: Ticket, label: "樂透對獎" },
    { key: "tools", href: "/tools", icon: Wrench, label: "實用工具" },
