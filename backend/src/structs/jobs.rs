...
impl AppJob {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            AppJob::FetchGovTenders => "FetchGovTenders",
    ...
    pub fn cron_expression(&self) -> &str {
        match self {
            ...
            // 每日 UTC 23:00（= UTC+8 07:00）；採購網公告每日更新，早上抓前一日增量
            AppJob::FetchGovTenders => "0 0 23 * * *",
    ...
    pub async fn run(&self, state: AppState) {
        match self {
            ...
            AppJob::FetchGovTenders => crate::jobs::fetch_gov_tenders::run(state).await,
