...
/// 加這條的動因:audit middleware 對 **admin 不分讀寫、GET 也記**(見 `middleware/audit.rs`;
/// member 那側 2026-08-09 起只記非 GET),所以任何 admin 唯讀查詢(含 `scripts/kawa-logs`
/// 那個 admin 帳號)都會累積筆數,而這張表原本是全站唯一
